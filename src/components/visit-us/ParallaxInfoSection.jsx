    ...
    >
      ...
      <div className="relative z-10 max-w-[1080px] mx-auto px-6 py-12">
        ...
        >
          ...
          <p style={{ textAlign: "justify" }}>
            We have drinking water on-site free of charge. In addition, we have
            several delicious food options available for purchase throughout the
            day, prepared-to-order by our (extremely) talented staff using fresh
            ingredients we get from the market daily! We try to accommodate any
            dietary restrictions or preferences. There are also several options
            for cold beverages.
          </p>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Good shoes and sandals/flip-flops &ndash; you might need to cross
              the river!
            </li>
            <li>Sunscreen</li>
            <li>Sunglasses</li>
        ...
        >
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            towards our project site (17kms from Pai town). Transportation will
            be provided at no additional cost. Alternatively, you can follow our
            truck on your motorbike, or directly reach the land at 13:30. The
            truck heads back to town around 17:00.
          </p>
