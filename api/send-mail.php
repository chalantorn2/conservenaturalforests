<?php
// ============================================================
// Conserve Natural Forests - Form Mail Handler
// PHP 8.3 | Receives form data via JSON POST, sends HTML email
// ============================================================

// --- Configuration ---
$RECIPIENT_EMAIL = 'anchalanimitmala194@gmail.com ';
$SITE_NAME       = 'Conserve Natural Forests';
$FROM_EMAIL      = 'noreply@conservenaturalforests.org';
...
$sent = sendMail($RECIPIENT_EMAIL, $subject, $html, $FROM_EMAIL, $SITE_NAME, $replyTo, $d['name'] ?? '');

// --- Auto-reply to submitter ---
if ($sent && $autoReplyHtml !== '') {
    sendMail($replyTo, $autoReplySubject, $autoReplyHtml, $FROM_EMAIL, $SITE_NAME);
}
